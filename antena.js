function Antena(scaleX, scaleY, scaleZ) {
	...
	this.draw = function(modelMatrix) {
	    ...
	    mat4.translate(matrix_seccionAntenaDos, matrix_seccionAntenaDos, [0, 0, -1.2 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_seccionAntenaTres, matrix_seccionAntenaTres, [0, 0, 1.2 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_seccionAntenaCuatro, matrix_seccionAntenaCuatro, [0,0, 2.4 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_cilindroUnionUno, matrix_cilindroUnionUno, [0, -1 * this.escalaY, -0.05 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_cilindroUnionDos, matrix_cilindroUnionDos, [0, -1 * this.escalaY, -1.25 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_cilindroUnionTres, matrix_cilindroUnionTres, [0, -1 * this.escalaY, 1.15 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_cilindroUnionCuatro, matrix_cilindroUnionCuatro, [0, -1 * this.escalaY, 2.35 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_cilindroLargoUno, matrix_cilindroLargoUno, [0.1, -1 * this.escalaY, -2 * this.escalaZ]);
	    ...
	    mat4.translate(matrix_cilindroLargoDos, matrix_cilindroLargoDos, [-0.1, -1 * this.escalaY, -2 * this.escalaZ]);
